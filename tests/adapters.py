...
from cs336_basics.train_model import AdamW, cross_entropy, get_batch, gradient_clipping, learning_rate_schedule, load_checkpoint, save_checkpoint
...
def run_rope(
    ...
    """
    test = RotaryPositionalEmbedding(theta, d_k, max_seq_len)
    return test.forward(in_query_or_key, token_positions)
